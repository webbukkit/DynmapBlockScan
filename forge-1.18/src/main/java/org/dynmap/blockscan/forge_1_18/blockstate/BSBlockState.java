package org.dynmap.blockscan.forge_1_18.blockstate;
...
public class BSBlockState {
    ...
    public List<VariantList> getMatchingVariants(Map<String, String> prop, Map<String, BlockModel> models) {
    	...
    	if (this.variants != null) {
    		for (Entry<BaseCondition, org.dynmap.blockscan.forge_1_18.blockstate.VariantList> var : this.variants.map.entrySet()) {
