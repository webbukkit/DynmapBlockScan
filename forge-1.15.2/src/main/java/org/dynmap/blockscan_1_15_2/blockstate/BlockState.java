package org.dynmap.blockscan_1_15_2.blockstate;
...
public class BlockState {
    ...
    public List<VariantList> getMatchingVariants(Map<String, String> prop, Map<String, BlockModel> models) {
    	...
    	if (this.variants != null) {
    		for (Entry<BaseCondition, org.dynmap.blockscan_1_15_2.blockstate.VariantList> var : this.variants.map.entrySet()) {
