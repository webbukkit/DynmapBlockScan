package org.dynmap.blockscan.forge_1_14_4.blockstate;
...
public class BlockState {
    ...
    public List<VariantList> getMatchingVariants(Map<String, String> prop, Map<String, BlockModel> models) {
    	...
    	if (this.variants != null) {
    		for (Entry<BaseCondition, org.dynmap.blockscan.forge_1_14_4.blockstate.VariantList> var : this.variants.map.entrySet()) {
