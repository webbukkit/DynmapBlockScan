package org.dynmap.blockscan_1_17_1.blockstate;
...
public class BSBlockState {
    ...
    public List<VariantList> getMatchingVariants(Map<String, String> prop, Map<String, BlockModel> models) {
    	...
    	if (this.variants != null) {
    		for (Entry<BaseCondition, org.dynmap.blockscan_1_17_1.blockstate.VariantList> var : this.variants.map.entrySet()) {
